                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-6">
                                    ...
                                    <select id="codeNumber" class="form-control">
                            ...
                            <button id="btn-next" class="btn btn-success mt-2" style="width: 100%;">Continuar <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
                        </form>
                    </div>
                </div>
            </div>
